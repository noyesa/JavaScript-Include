...
An example module is located at @src/example.js@. You can ensure that it works but opening @src/example.html@.
...
|Safari 3|Mac OS X|{background:#40A662;color:white}.Success|
|Firefox 3|Mac OS X|{background:#40A662;color:white}.Success|
|Opera 9.6|Mac OS X|{background:#40A662;color:white}.Success|
|Google Chrome|Windows XP|{background:#40A662;color:white}.Success|
|Firefox 3|Windows XP|{background:#40A662;color:white}.Success|
|Opera 9.6|Windows XP|{background:#40A662;color:white}.Success|
|Internet Explorer 7|Windows XP|{background:#40A662;color:white}.Success|
|Internet Explorer 6|Windows XP|{background:#40A662;color:white}.Success|
|Internet Explorer 5.5|Windows XP|{background:#40A662;color:white}.Success{color:#999}|
