...
loaded.addFile(file);return true;};window.reload=function(path){var file=new SourceFile(path);if(loaded.hasFile(file)){loaded.getFile(file).parse();return true;}
return include(path);};})();